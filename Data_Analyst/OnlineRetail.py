...
# country_price_mean = data.pivot_table(
#     values="Quantity", index="InvoiceNo", columns="Country", aggfunc="mean"
# )
# min_max_customer = data.pivot_table(
#     values="Quantity", index="CustomerID", columns="StockCode", aggfunc={min, max}
# )
# stock_sum_mean = data.pivot_table(
#     values=["Quantity", "UnitPrice"],
#     index="StockCode",
#     aggfunc={"Quantity": np.sum, "UnitPrice": np.mean},
# )
# daily_total = data.pivot_table(values="Quantity", index="InvoiceDate", aggfunc="sum")

# conditions_previous = [
#     (data.InvoiceDate.str.split("/").str[0] == "1")
#     | (data.InvoiceDate.str.split("/").str[0] == "2")
#     | (data.InvoiceDate.str.split("/").str[0] == "3"),
#     (data.InvoiceDate.str.split("/").str[0] == "4")
#     | (data.InvoiceDate.str.split("/").str[0] == "5")
#     | (data.InvoiceDate.str.split("/").str[0] == "6"),
#     (data.InvoiceDate.str.split("/").str[0] == "7")
#     | (data.InvoiceDate.str.split("/").str[0] == "8")
#     | (data.InvoiceDate.str.split("/").str[0] == "9"),
#     (data.InvoiceDate.str.split("/").str[0] == "10")
#     | (data.InvoiceDate.str.split("/").str[0] == "11")
#     | (data.InvoiceDate.str.split("/").str[0] == "12"),
# ]
# choices = ["1", "2", "3", "4"]
...
# data.loc[(data.Country == "United Kingdom") & (data.Previous == "4"), "Discount"] = (
#     data["Amount"] * 0.1
# )
...
# data_1 = data_1[((data_1["Quantity"] < 0) | (data_1["UnitPrice"] == 0))]
